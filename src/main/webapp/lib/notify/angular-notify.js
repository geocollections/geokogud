angular.module('cgNotify', []).factory('notify',['$timeout','$http','$compile','$templateCache','$rootScope',
    function($timeout,$http,$compile,$templateCache,$rootScope){
        ...
        notify.success = function (msg) {
            return notify({message: msg, classes: 'alert alert-success'});
        };

        notify.warning = function (msg) {
            return notify({message: msg, classes: 'alert alert-warning'});
        };

        notify.error = function (msg) {
            return notify({message: msg, classes: 'alert alert-danger'});
        };
