angular.module('geoApp').directive('loading', function () {
    ...
    function () {
        return {
            ...
            controller: ['$scope', 'ApplicationService', function ($scope, ApplicationService) {
                            ...
                            if (feature) {
                                ...
                                if (name = feature.get('name')) {
                                    ...
                                    if (pikk == 1) {
                                        ...
                                        document.getElementById('hoversystem').innerHTML = pikk +
                                            ' clustered localities<br/>Zoom in to see';
                                    }
                                }
                                document.getElementById('hoverstat').innerHTML = "";
                            } else {
